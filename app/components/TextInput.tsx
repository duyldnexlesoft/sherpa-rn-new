...
const InputComponent = (props: any) => {
  ...
  return (
    <View className={'bg-white w-full border rounded-md flex-row items-center justify-between ' + cssBorder()} style={{height: props.height || 50}}>
      ...
      {props.label && (
        <Animated.Text
          className={`absolute top-4 rounded-md bg-white text-gray-500 px-2 ${!!field?.value || focusInput ? 'z-10' : ''}`}
